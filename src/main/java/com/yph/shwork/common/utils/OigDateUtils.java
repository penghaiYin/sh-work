...
public class OigDateUtils {
    ...
    * 常用的时间格式.
    */
   private static String[] parsePatterns = {"yyyyMMdd", "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy/MM/dd",
         "yyyy/MM/dd HH:mm:ss", "yyyy/MM/dd HH:mm", "yyyy-MM-dd'T'HH:mm:ss'Z'" };
   ...
   public static String getDate() {
      return getDate(OigDateUtils.DATE_FORMAT);
   }
   ...
   public static String getTime() {
      return formatDate(new Date(), OigDateUtils.TIME_FORMAT);
   }
   ...
   public static String getDateTime() {
      return formatDate(new Date(), OigDateUtils.DATETIME_FORMAT);
   }
   ...
   public static String formatDate(Date date, Object... pattern) {
      ...
      if (pattern != null && pattern.length > 0) {
         ...
         formatDate = DateFormatUtils.format(date, OigDateUtils.DATE_FORMAT);
      }
      return formatDate;
   }
   ...
   public static long pastDays(Date date) {
      ...
      date = OigDateUtils.parseDate(OigDateUtils.formatDate(date, OigDateUtils.DATE_FORMAT));
      // 当前日期转换为yyyy-MM-dd格式
      Date currentDate = OigDateUtils.parseDate(OigDateUtils.formatDate(new Date(), OigDateUtils.DATE_FORMAT));
      long t=0;
      if(date!=null&&currentDate!=null){
         t = (currentDate.getTime() - date.getTime()) / OigDateUtils.MILLISECONDS_PER_DAY;
      }
      return t;
   }
   ...
   public static long getDaysBetween(Date start, Date end) {
      // 将指定日期转换为yyyy-MM-dd格式
      start = OigDateUtils.parseDate(OigDateUtils.formatDate(start, OigDateUtils.DATE_FORMAT));
      // 当前日期转换为yyyy-MM-dd格式
      end = OigDateUtils.parseDate(OigDateUtils.formatDate(end, OigDateUtils.DATE_FORMAT));

      long diff=0;
      if(start!=null&&end!=null) {
         diff = (end.getTime() - start.getTime()) / OigDateUtils.MILLISECONDS_PER_DAY;
      }
      return diff;
   }
   ...
   public static long getWeeksBetween(Date start, Date end) {
      return getDaysBetween(start, end) / OigDateUtils.DAYS_PER_WEEK;
   }
   ...
   public static String getSpecifiedDayAfter(String specifiedDay, int num) {
      ...
      String dayAfter = formatDate(c.getTime(), OigDateUtils.DATE_FORMAT);
      return dayAfter;
   }
    ...
    * @since 1.0
    */
   public static String getSpecifiedDayAfter(String specifiedDay, int num, String pattern) {
	   Date specifiedDate = parseDate(specifiedDay);
	   Calendar c = Calendar.getInstance();
	   c.setTime(specifiedDate);
	   int day = c.get(Calendar.DATE);
	   c.set(Calendar.DATE, day + num);
	   String dayAfter = formatDate(c.getTime(), pattern);
	   return dayAfter;
   }
   ...
   public static String dateMinus(Date date1, Date date2) {
      ...
      double result = r * 1.0 / OigDateUtils.MILLISECONDS_PER_HOUR;
   ...
   public static String getIntervalBySeconds(long seconds) {
      ...
      if (seconds < SECONDS_PER_MINUTE) {
         ...
         buffer.append(seconds / OigDateUtils.SECONDS_PER_YEAR).append("年前");
      }
   ...
   public static int getMonthsBetween(String startDate, String endDate) {
      ...
      c1.setTime(OigDateUtils.parseDate(startDate));
      c2.setTime(OigDateUtils.parseDate(endDate));
   ...
   public static String snsFormat(long createTime) {
    ...
    /**
   	 * 计算当前时间，与输入天数向前或者向后日期
   	 * 
   	 * @param day
   	 * @return
   	 * @throws ParseException
   	 */
   	public static Date intervalTime(int day) throws ParseException {
   	...
   	public static void main(String[] args) {
   		String a = formatDate(parseDate("202108"), "yyyy年MM月");
